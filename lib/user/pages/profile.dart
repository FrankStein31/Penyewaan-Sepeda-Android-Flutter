          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                // Laporan total rental user
                FutureBuilder<Map<String, dynamic>>(
                  future: _fetchRentalSummaryByName(userName),
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      return const Center(child: CircularProgressIndicator());
                    }
                    if (snapshot.hasError) {
                      return const Text('Gagal memuat laporan rental');
                    }
                    final data = snapshot.data ?? {'total': 0, 'amount': 0};
                    return Container(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                const Icon(Icons.pedal_bike, color: Colors.white, size: 36),
